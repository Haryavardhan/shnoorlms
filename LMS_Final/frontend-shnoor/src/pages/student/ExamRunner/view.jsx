      ...
      <div className="h-16 bg-slate-900 text-white px-6 flex items-center justify-between shrink-0 shadow-md z-20">
        ...
        {!isPractice && (
          <div className="flex items-center gap-4">
            ...
            <button
              className="bg-red-500 hover:bg-red-600 text-white text-sm font-bold py-2 px-4 rounded-lg shadow-md transition-colors"
            ...
            <div className="w-full bg-white rounded-2xl shadow-sm border border-slate-200 flex flex-col h-full md:h-auto overflow-hidden">
              ...
              <div className="p-6 md:p-8 flex-1 grid gap-4">
                {currentQ.options.map((opt, i) => (
                  <label
                    key={i}
                    className={`group flex items-center gap-4 p-4 md:p-5 rounded-lg border-2 cursor-pointer transition-all ${answers[questionId] === opt
                      ? "border-indigo-500 bg-indigo-50 ring-1 ring-indigo-500"
                      : "border-slate-200 bg-white hover:border-indigo-300 hover:bg-slate-50"
                      }`}
                  >
                    <div
                      className={`w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${answers[questionId] === opt
                    ...
                    />
                    <span
                      className={`text-lg transition-colors ${answers[questionId] === opt
